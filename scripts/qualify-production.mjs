...
const required = [
  ...
  'src/server.js','src/security.js','src/core.js','src/pricing.js','src/evidence.js','src/anchoring.js','src/watchdog.js','src/watchdog-provider-brave.js','src/billing.js','src/workflows.js','src/search-engine.js',
  'supabase/migrations/001_ipx_production.sql','supabase/migrations/002_watchdog.sql','supabase/migrations/003_fee_sync_and_commercial.sql','supabase/migrations/004_entitlements_and_evidence_uploads.sql','supabase/migrations/005_idempotent_fulfillment.sql','supabase/migrations/006_service_catalog_and_watchdog_pricing.sql','supabase/migrations/007_billing_workflows_and_office_operations.sql',
...
for(const p of ['src/server.js','src/security.js','src/core.js','src/pricing.js','src/evidence.js','src/anchoring.js','src/watchdog.js','src/watchdog-provider-brave.js','src/billing.js','src/workflows.js','src/search-engine.js']){try{execFileSync(process.execPath,['--check',p],{stdio:'inherit'});}catch{errors.push(`${p}:syntax`);}}
...
console.log(JSON.stringify({ok:true,checks:['required-files','no-placeholders','unit-tests','syntax','evidence-flow','billing-ledger','service-catalog','office-workflows','docketing','ownership-chain','search-foundation','watchdog-flow','schema-controls','governance-docs','security-docs','provenance-docs']},null,2));
